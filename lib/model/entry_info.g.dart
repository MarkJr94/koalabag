...
Serializer<EntryInfo> _$entryInfoSerializer = new _$EntryInfoSerializer();

class _$EntryInfoSerializer implements StructuredSerializer<EntryInfo> {
  @override
  final Iterable<Type> types = const [EntryInfo, _$EntryInfo];
  @override
  final String wireName = 'EntryInfo';

  @override
  Iterable serialize(Serializers serializers, EntryInfo object,
  ...
  @override
  EntryInfo deserialize(Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new EntryInfoBuilder();
...
class _$EntryInfo extends EntryInfo {
  @override
  ...
  factory _$EntryInfo([void updates(EntryInfoBuilder b)]) =>
      (new EntryInfoBuilder()..update(updates)).build();
  ...
  _$EntryInfo._(
      ...
      : super._() {
    if (createdAt == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'createdAt');
    }
    if (id == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'id');
    }
    if (isArchived == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'isArchived');
    }
    if (isStarred == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'isStarred');
    }
    if (readingTime == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'readingTime');
    }
    if (tags == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'tags');
    }
    if (title == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'title');
    }
    if (updatedAt == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'updatedAt');
    }
    if (url == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'url');
    }
    if (userEmail == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'userEmail');
    }
    if (userId == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'userId');
    }
    if (userName == null) {
      throw new BuiltValueNullFieldError('EntryInfo', 'userName');
    }
  }

  @override
  EntryInfo rebuild(void updates(EntryInfoBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  EntryInfoBuilder toBuilder() => new EntryInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EntryInfo &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('EntryInfo')
...
class EntryInfoBuilder implements Builder<EntryInfo, EntryInfoBuilder> {
  _$EntryInfo _$v;
  ...
  @override
  void replace(EntryInfo other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$EntryInfo;
  }

  @override
  void update(void updates(EntryInfoBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$EntryInfo build() {
    _$EntryInfo _$result;
    try {
      _$result = _$v ??
          new _$EntryInfo._(
              createdAt: createdAt,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'EntryInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
